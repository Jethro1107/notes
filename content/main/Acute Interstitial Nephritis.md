---
id: 7fe24dcb-74ad-466f-b5ba-18817337e363
...
- **Etiology of AIN** - traditionally most commonly caused by methicillin, which has subsequently been withdrawn from market:
    ...
    - **Infections** (4-10%) - may be attributed to the infection or the medications for the infection:
        ...
        - <u>Viral infections</u> - CMV, EBV, Hantavirus etc.
...
- **Clinical features of AIN** - timing of onset is variable (median 10d), but onset after subsequent exposure is more rapid than initial exposure:
    - **Clinical features of renal dysfunction** - many are asymptomatic:
        ...
        - <u>Proteinuria</u> - modest aamounts due to tubular proteinuria (PCR \< 100 mg/mmol), nephrotic range only occurs in the context of co-exisitng glomerular disease, especially if a/w NSAID (NSAID-related MCD/ MN) or autoimmune disease (SLE)
...
- **Ix:**
    - **Urine** - dipstick, urine microscopy, quantification of proteinuria, and aditional urinalysis:
        ...
        - <u>Quantification of proteinuria</u> (ACR, PCR) - typically minimal (PCR \< 100 mg/mmol) accounting for tubular proteinuria, but may have nephrotic range if concurrent glomerular disease (e.g. NSAID, autoimmune disease)
    ...
    ![](../img/mx_algo_for_ain_uptodate.png)
- **Mx:**
    - **Principles of Mx:**
    ...
    - **Mx of drug-induced allergic AIN:**
        ...
        - **Rescue immunosuppressive therapy** - MMF 1-2g PO in patients w/ Bx-proven AIN and documented failure to respond to glucocorticoids
