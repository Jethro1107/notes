---
id: F26EEFA4-8F45-4967-86CF-19B52F62EA9E
roam_parent: 3203d0b3-6baa-4683-9637-8e7fcf9038ff
title: Idiopathic Inflammatory Myopathies
---

# Idiopathic Inflammatory Myopathies

- **Definition** - heterogenous group of rheumatological disorders characterised by a systemic inflammatory process w/ pre-dilection to the skeletal muscles, notorious for its association with ILD and malignancies
...
- **Major types of inflammatory myopathies** (IMs):
  ...
  ![](../img/clinical_and_laboratory_features_of_major_types_of_inflammatory_myopathies.png)
...
- **Associated conditions** - notorious for its association w/ 1) malignancies and 2) ILDs:
    - May present in association w/ other autoimmune diseases, such as SLE, SSc and Sjogren's syndrome
    - Certain DMs w/ anti-TIF1, anti-NXP2 associated w/ 3x increased risk of malignancy that persists for at least 5y after Dx
    - Certain myopathies such as anti-MDA5 and ASyS associated w/ clinically significant ILD
- **Clinical features of idiopathic inflammatory myopathies:**
    - **Muscle weakness** - due to inflammatory destruction of muscles, usually resulting in widespread <u>symmetrical proximal muscle weakness</u> (w/ exception of IBM):
        - <u>Site</u>:
    ...
    ![](../img/skin_signs_of_dermatomyositis.png)
...
- **Initial Ix** - if unable to localise based on Hx and clinical examination alone:
    ...
    - <u>Serum aldolase</u> - marker of muscle destruction when CK is normal
    ...
    - <u>PFT</u> - to detect restrictive physiology seen in clinically significant ILDs
    - <u>Malignancy screen</u> - CT T+A+P, mammography, and complete endoscopy (OGD + CLN), +/- nasoendoscopy
- **Muscle Bx:**
    ...
    - <u>Approaches to muscle Bx</u>:
        - Blind (driven by clinical examination)
        - MRI-guided Bx (considered if initial Bxis normal due to patchy myositis)
...
- **Dermatomyositis** (DM):
    ...
    - **Ix:**
      ...
      ![](../img/msa_harrisons.png)
        ...
        ![](../img/perivfascicular_atrophy_of_dermatomyositis.png)
        ...
        ![](../img/mxa_protein_staining_dermatomyositis.png)
...
- **Polymyositis** (PM):
    ...
    - **Clinical features of PM** - similar to other inflammatory myopathies:
        - **Weakness** - due to myopathic process that is typically 1) <u>symmetrical</u>, and 2) <u>proximal greater than distal</u>, which may be a/w <u>myalgia</u> (although severe myalgia w/ absence of objectively demonstrable weakness is unlikely IMs)
    - **Ix:**
        - **Markers of muscle damage** - serum CK, serum aldolase:
        ...
        ![](../img/histopathology_of_polymyositis.png)
        - **Prognosis:**
...
- **Immune-mediated necrotising myositis** (IMNM):
    - **Causes of IMNM:**
...
- **Anti-synthetase syndrome** (ASyS):
    - **Definition** - specific syndrome of 1) myositis, 2) non-erosive arthritis, 3) ILD associated w/ <u>antibodies against aminoacyl-tRNA synthetase</u>
    ...
    - **Ix:**
      ...
      ![](../img/histopathology_of_antisynthetase_syndrome.png)
    - **Prognosis:**
...
- **Mx:**
    ...
    ![](../img/inflammatory_myopathies_immunotherapy.png)
