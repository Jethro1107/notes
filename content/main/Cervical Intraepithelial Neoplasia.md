---
id: 39719552-c32b-4875-9387-baa22947462d
title: Cervical Intraepithelial Neoplasia
---
...
- **Definition and terminology** - in the Bethesda system, different terminology are used for cytological (Pap smear), and histological (on biopsy) findings:
  ...
  ![](~/Documents/notes/img/terminology_and_histology_of_cervical_intraepithelial_neoplasia.png)
- **Epidemiology:**
...
- **Mx:**
    - **Principles of Mx:**
        ...
        - **Considerations for appropriate Mx** - dependent on 1) risk for progression to cancer, 2) treatment-related morbidity, 3) likelihood of compliance:
            ...
            - <u>Preceeding cytological results</u> - discordance between cytology and histology (e.g. ASC-H or HSIL but CIN1 on colposcopy) should lower threshold for definitive Tx as the concern is that an underlying high-grade lesion is missed on colposcopy
        - **Mx of CIN1:**
            - <u>CIN preceded by LSIL or less</u> - conservative Mx w/ repeat cytology and HPV testing
            - <u>CIN preceded by ASC-H</u> - conservative Mx w/ repeat cytology and HPV testing preferred if entire SCJ is visible on colposcopy
            - <u>CIN preceded by HSIL</u> - diagnostic excisional procedure is preferred, especially if not the entire SCJ and lesion is visible on colposcopy
    ...
    - **Loop electrosurgical excisional procedure** (LEEP) - also known as large loop excision of transformation zone:
        - <u>Complications</u>:
            - Early complications - intra-operative and post-operative bleeding, infections
            - Late complications - cervical stenosis, cervical incompetence, adverse obstetrics outcome (PROM, premature labour, low-birth weight)
- **Prevention:**
...
- **HPV vaccination** - prevention of high-risk HPV infection theoretically can prevent cervical cancer:
    - <u>Different types of HPV vaccines</u>:
        - Bivalent - 16 and 18
        - Quadrivalent - 6, 11, 16, 18
        - Nonavalent - 6, 11, 16, 18, 31, 33, 45, 52, 58
    - <u>Scheduling</u> - 2-dose scheduling within 6-12mo apart is currently gold standard as recommended by WHO:
        - Historically, a 3-dose vaccination schedule is used
        - Currently, single-dose schedule is under investigations w/ suggested comparative efficacy, which may simplify vaccination programmes
    - <u>Current recomendations</u> - HPV vaccination program for P5-6 girls started in 2019:
        - 2-dose regimen for \< 15y
        - 3-dose regimen for \> 15y
