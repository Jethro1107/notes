---
id: 57d4e5f5-273d-4431-b53d-6f343b843e4c
...
- **Epidemiology** - BPH is extremely common but not all are symptomatic:
    - **Prevelance:**
        ...
        - <u>Age of incidence</u> - occurs in M \> 50y, by 60y, 50% will have histological evidence of BPH
    - **Most common cause of LUTS and BOO** - in M \> 70y
- **Pathophysiology of BPH** - often attributed to aging:
    - <u>Increased oestrogen-testosterone ratio</u> - Rate of decline of estrogen level does not match testosterone, resulting in increased secretion of intermediate peptide growth factor
    - <u>Glandular and stromal hyperplasia and transitional zones of the prostate</u> - results in yearly enlargement from 40y, which maybe hormonally driven (BPH not observed in patients with hypogonadism)
...
- **Clinical features of BPH** - progressive clinical course in old age (spontaneous improvement seen in minority of patients):
    ...
    - **Complications:**
        - <u>Acute retention of urine</u> - sudden inability to urinate a/w suprapubic discomfort
        ...
        - <u>Hernia</u> - due to straining to void
        - <u>Bleeding BPH</u> - presentation w/ haematuria
- **Signs of BPH:**
...
- **Principles of Mx:**
    - <u>Lifestyle modifications for all patients</u> - behavorial interventions to minimise impact of LUTS from complications
    - <u>Medical therapy</u> - indicated if LUTS persistent despite lifestyle modification
    - <u>Surgical therapy</u> - definite indications if complicated BPH, otherwise based on paient preference
...
- **Surgical treatment** - trans-urethral resection of prostate (TURP):
