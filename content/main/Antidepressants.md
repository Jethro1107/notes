---
id: EE752169-E3D1-4C90-8C88-075B84BB54B2
...
- **Classification of antidepressant drugs into 3 main classes depending on acute pharmacological properties** - in a broad sense they are of <u>equivalent efficacy</u>, differing only in safety and adverse activities:
	...
	![](../img/antidepressants_advantages_and_disadvantages.png)
...
- **Selective serotonin reuptake inhibitors** - now preferred to TCAs as first-line treatment of depression as moderately better tolerated and markedly less toxic in overdose w/ comparable efficacy:
	- **Selection**:
		...
		- Citalopram
		- Escitalopram
	- **Pharmacodynamic properties and MOA**:
	...
	- **Pharmacokinetics of SSRIs**:
		- <u>Absorption</u> - slow, reaching peak plasma levels after 4-8h, although citalopram and escitalopram are absorbed faster
		- <u>Metabolism</u> - most undergo extensive hepatic metabolism, but the metabolites are also bioactive:
		...
		- <u>Excretion</u> - renal excretion, overall half-lives around 24h but fluoxetine is 48-72h:
			- Fluoxetine - 48-72h
			- Others - 20-30h
- **Efficacy of SSRIs in depression** - extensively compared w/ placebo and TCAs:
...
- **S/E**:
	...
	![[Pasted image 20260409101322.png]]
	- <u>GI discomfort</u> - N/V (20% but resolves w/ continuous administration), dyspepsia, bloating, flatulence, and diarrhoea
	- <u>Weight gain</u> - over longer term Tx, most significantly w/ paroxetine
	- <u>Neuropsychiatric effects:</u>
...
- **SSRIs and violence and suicidal behaviour** - anecdotal reports where SSRI treatment may be a/w hostile and suicidal behaviour but a meta-analysis shows:
...
- **Drug interactions for SSRIs**:
	- <u>Pharmacokinetic interactions</u> - precipitating serotonin syndrome (hyperpyrexia, w/ mental and motor manifestations) through interacting w/ drugs that increase 5-HT function:
		- MAOIs
		- Lithium and tryptophan
		- Tramadol
		- Linezolid
		- Sumatriptan (5-HT receptor agonist)
	- <u>Pharmacokinetic interactions</u> - fluoxetine and paroxetine produce <u>substantial inhibition of P450 enzymes</u>, increasing drug levels of other drugs: 
		
		![](../img/pharmacokinetic_interactions_of_ssris.png)
- **Practical issues in the clinical use of SSRIs in Tx of depression**:
	- <u>Selection of antidepressants</u> - based on tolerability, and S/E profiles:
		...
		![](../img/differences_in_ssri.png)
	- <u>Initiation of antidepressants:</u>
	...
	- <u>Monitoring of antidepressant use:</u>
	...
	- <u>Continuation of antidepressant use:</u>
	...
	- <u>Stopping antidepressant use</u> - graded reduction rather than stopping suddenly:
...
- **Tricyclic antidepressants** - although no longer first line, still remains useful in treatment-refractory illness and those w/ severe depression (Cowen and Anderson 2015):
	- **Selection** - useful distinction between those that have a terminal methyl group side chain (tertiary amines), and those that do not:
		- <u>Tertiary amines</u> (more potent alpha-1 and muscarinic receptor antagonism) - e.g. amitriptyline, clomipramine, imipramine, lofepramine
		- <u>Secondary amine</u> (less potent antagonism of other receptors) - desipramine, nortriptyline, dosulepin, doxepin
	- **MOA** - three-ringed structure attached to side chains:
		- Inhibition of reuptake of 5-HT and noradrenaline (inhibition of reuptake of NA >>> 5-HT)
	...
	- **Pharmacokinetics of TCAs**:
		- <u>Absorption</u> - well absorbed in GI tract; peak plasma levels 2-4h after ingestion
		- <u>Transport, circulation and distribution:</u>
		...
		- <u>Excretion</u> - half-life long enough to allow for od dosing
	- **S/E**:
		
		![[Pasted image 20260409101348.png]]
		- <u>Anticholinergic effects</u> - dry mouth, and blurry vision are most common; most important being acute closed-angle glaucoma and acute urinary retention:
			- Dry mouth
			- Blurry vision (disturbances of accomodation)
			- Urinary hesitancy or retention
			- Constipation
		- <u>Psychiatric effects:</u>
			- Sedation (w/ amitryptaline)
			- Insomnia (lofepramine, desipramine)
			- Mania in underlying bipolarity
		- <u>Cardiovascular effects:</u>
			- Rhythm abnormalities - prolongation of PR and QT intervals, heart blocks, tachycardias
			- Postural hypotension - due to alpha-1 adrenergic receptor blockade
		- <u>Neurological effects:</u>
			- Fine tremor (common)
			- Incoordination
		...
		- <u>Other effects:</u>
			...
			- Agranulocytosis
		- <u>Withdrawal effects</u> - N/V, agitation/ anxiety, sweating, GI Sx, insomnia and vivid dreaming
	- **Toxic effects in TCA overdose** - corresponds to S/E, but most being:
	...
	- **Practical considerations in the clinical use of TCAs**:
		- <u>Selection of TCAs</u> - based on 1) sedation, 2) considerations of overdose, and 3) comorbid conditions:
		...
		- <u>Dosing and monitoring</u> - start low and go slow:
