---
id: bb8b847e-aaeb-44f5-9a78-9ab9f95f606c
title: Vasculitis
---

# Vasculitis

- **Definition** - Heterogenous group of disease characterised by <u>inflammation</u> and <u>necrosis</u> of the blood vssel walls, with associated damage to the organs they supply (e.g. skin, kidneys, lungs, heart, brain, GI tract)
...
- **Vasculitic syndromes:** ![](../img/vasculitic_syndrome.png) 
![](../img/classification_of_vasculitis_by_anatomical_distribution.png)
- **Pathophysiology of vasculitis:**
    ...
    ![](../img/vasculitic_syndromes_and_their_predominant_hypothesis_of_pathophysiology.png)
...
- **Clinical features of vasculitis** - classified into 1) features of local tissue ischaemia, and 2) systemic inflammation: 
![](../img/clinical_features_of_systemic_vasculitides.png)
- **Features suggestive of vasculitic phenomenon** - any patient w/ unexplained multisystemic illness:
    - No-specific inflammatory condition (e.g. fever, weight loss, fatigue, raised inflammatory markers)
    - Palpable purpura (or livedo reticularis) 
    ![](../img/palpable_purpura_in_vasculitis.png)
...
![](../img/conditions_that_mimic_vasculitis.png)
- **Approach to patient w/ suspected Dx of vasculitis:** 
![](../img/approach_to_patient_with_suspected_vasculitis.png)
...
![](../img/common_side_effects_for_drugs_for_vasculitis.png)
