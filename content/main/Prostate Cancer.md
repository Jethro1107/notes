---
id: a0151d41-f4d3-434d-9443-5b6c60122a98
...
- **Raised PSA in prostate cancer** - there is single threshold for defining abnormal PSA value:
    - **Traditional cutoff for raised PSA** - classically 4 ng/mL (although age-specific cutoffs are proposed):
        - <u>PSA 4-10 ng/dL</u> - 40% have cancer on Bx (hence raised PSA opens discussion to Bx)
        - <u>PSA \< 4 ng/dL</u> - 25% have cancer on Bx (hence low PSA does not r/o cancer)
...
- **Dx** - principally a <u>histological Dx</u>, but approach to Dx may depend on stage at presentation:
...
- **Gleason grading system** - assessment of primary (most common) and secondary (second most common) histological architecture upon prostate Bx prior to Tx which predicts likelihood of non-organ confined disease and outcomes after local Tx:
    ...
    ![](img/isup_grade_group_classification_system_for_pca.png)
- **Staging system** - AJCC 8th edition TNM staging (2017):
    ...
    - **TNM staging for prostate cancer:** ![](img/ajcc_8e_tnm_staging_for_pca_t_stage.png) 
    ![](img/ajcc_8e_tnm_staging_for_pca_n_m_stage.png)
    - **AJCC 8e prognostic stage groups** - dependent on 1) TNM staging, 2) PSA levels, and 3) Gleason Grade Group: 
    ![](img/prostate_cancer_prognostic_grade_group.png)
- **Risk stratification based on nomogram** - informs further 1) staging evaluation and 2) Mx of localised disease:
    ...
    ![](img/nccn_risk_stratification_system_for_clinically_localised_pca.png)
...
- **Staging Ix** - MRI for all, but <u>detection for distant metastasis</u> typically indicated for <u>symptomatic or high-risk disease</u>:
    - **Multiparametric prostate MRI** - may have been performed prior to prostate Bx under current paradigm; if performed has role in <u>loco-regional staging</u>
...
- **Mx:**
    - **Principles of Mx:**
        - <u>Organ-confined disease</u> - options include watchful waiting and active surveillance, radical prostatectomy, radical radiotherapy +/- adjuvant androgen deprivation therapy based selected based on risk stratification
        - <u>Locally advanced disease</u> - multimodal approach (radical prostactectomy and pelvic LN dissection + adjuvant RT/ADT)
        - <u>Metastatic disease</u> - hormonal therapy (e.g. androgen-deprivation therapy \[ADT\], androgen synthesis blocker, androgen receptor blockade), chemotherapy, immunotherapy or radioligand therapy

## Management of localised prostate cancer

- **Principles of Mx:**
    - <u>Shared decision making</u> - decision of Tx is made w/ patient by expecting the benefits and risks of each modality
    - <u>NCCN schema for risk stratification</u> - provides a baseline risk stratification to determine optimal Tx for patients:
        - **NCCN very low- or low-risk groups** - active surveillance/ watchful waiting for all patients
        - **NCCN intermediate-, high- or very high-risk groups** - radical Tx is often indicated in these patients
    - <u>Additional factors</u> - additional prognostic factors that may influence selection of Mx in risk groups:
        - **Patient age and co-morbidity** - life-expectancy determines whether watchul waiting is persued in very-low risk patients
        - **Tissue-based molecular profiling** - molecular profiling can be applied to low-risk individuals which may identify subset of patient that may benefit radical Tx
        - **Germline mutations** - germline status of BRCA1, BRCA2, ATM and CHEK2 is often a/w higher rate of reclassificaiton in active surveillance
        - **Percentage of +ve Bx** - applied to stratify intermediate risk groups into favourable intermediates and unvavourable intermediates:
        ...
        - **Poor prognostic histology** - presence of cribiform or intraductal histopathology may be an indication for radical Tx
- **Approach to Mx of very-low or low-risk clinically localised prostate cancer:**
    - **Mx of very low-risk disease:**
        - <u>Life expectancy \> 10y</u> - <u>active surveillance</u> pursued for post-ponent of immediate definitive therapy; however immediate radical therapy is also acceptable out of patient-preference
        - <u>Life expectancy \< 10y</u> - <u>watchful waiting</u> and initiate palliative Tx once symptomatic
    - **Mx of low-risk disease:**
        ...
        - **Active surveillance** - indicated for <u>most patients</u> w/ absence of high-risk gene expression and/or histopathologies (e.g. cribiform/ intraductal pathology)
...
- **Approach to Mx of intermediate-, high-, or very high-risk clinically localised prostate cancer:**
...
- **Watchful waiting** - follow-up w/o curative intent:
    - <u>Definition</u> - monitoring of prostate cancer to detect Sx arise from prostate cancer and symptomatic Tx, with minimal focus on risk stratification and clinical staging of disease
    - <u>Indications</u> - if disease unlikely to cause reduced survival and suffering:
        - Patients with **asymptomatic disease** as a pre-requisite
        - Patients where **Tx has no prognostic implications** in terms of survival (e.g. life expectancy \< 10y) and unlikely to cause problems during lifetime
    - <u>Approach to FU</u>:
        - Monitor Sx and provide Sx-based interventions (e.g. catheterisation for AROU)
        - Routine PSA, imaging and Bx not mandatory and may be used only if clinically indicated
        - ADT initiated +/- palliative RT in cases of symptomatic metastatic disease
- **Active surveillance** - follow-up w/ curative intent but to defer curative Tx to shorten duration of adverse functional outcomes:
    - <u>Indications</u> - very low-, low- and selected favourable intermediate risk by NCCN schema:
        - Low tumour volume (cT1-cT2a)
        - Low risk disease by PSA and Gleason Grade Group
    - <u>Approach</u> - structured follow-up protocol:
        - Clinical assessment - regular DRE
        - Biochemical assessment - regular PSA
        - Radiological assessment - potential role of regular multiparametric MRI assessment
        - Pathological assessment - regular prostate Bx to detect Gleason Grade Reclassification
    - <u>Indications to opt out of protocol</u>:
        - Patient's wishes - as regular assessment may create significant anxiety and causes some patients to subsequently choose definitive intervention despite absence of progressive disease
        - Disease progression - either biochemically, radiologically or upgrade on repeat prostate biopsy
    - <u>Evidence for active surveillance in localised prostate cancer</u> - protecT trial:
        - **Study design:**
...
![](img/comparison_between_prostatectomy_and_rt_in_prostate_cancer.png)
- **Radical external beam rdiation therapy** (EBRT):
    ...
    - <u>Dosing</u>:
        - Conventional dose fraction - 74-78 Gy over 37-39 \# over 7-8 weeks
        - Hypofraction - 60Gy over20# over 4 weeks
        - SABR dose fractionation - 36.25 Gy over 5# over 2 weeks (alternative days)
    ...
    - <u>S/E</u>:
        - **Short term:**
            - <u>General</u> - Fatigue, skin reaction, local hair loss
            - <u>Gastrointestinal</u> - acute radiation proctitis (PR bleeding, mucus discharge, faecal urgency), radiation enteritis if SB irradiated in N1 disease (e.g. diarrhoea, flatulence, abdominal cramping)
            - <u>Urinary</u> Sx - frequency, urgency, incontinence, haematuria due to radiation cystitis and urethritis
        - **Long-term:**
            - <u>Gastrointestinal</u> - chronic radiation proctitis, fistula
            - <u>Urinary</u> - chronic radiation cystitis, incontinence, urethral stricutres
            - <u>Sexual</u> - erectile dysfunciton and impotence
            - <u>Neoplastic</u> - Second malignancy (theoretical risk but is late S/E, generally do not live long enough to experience this)
        - **ADT S/E** in intermediate and high risk patients (e.g. hot flushes)
- **Brachytherapy** - another viable option for very-low or low-risk disease although limited by operative risk of implantation, and suboptimal anatomy:
    - LDR - requires implantation of radioactive seeds
    - HDR - requires insertion of radioactive rods to deliver radiation
...
## Management of metastatic castration-sensitive prostate cancer
...
- **Approach to systemic therapy for metastatic disease:**
  ...
  ![](img/initial_mx_for_patients_with_recurrence_or_metastatic_castration_sensitive_prostate_cancer.png)
...
- **Novel hormonal therapy** - evidence points to early intensification hence indicated in 1L mHSPC:
    - **Abiraterone** - 1st generation anti-androgen therapy:
        - <u>MOA</u> - androgen synthesis inhibitor through **inhibition of CYP17A1**:
            - **Reduced androgen synthesis** - testes, adrenal glands, and prostatic tumour
            - **Reduced cortisol synthesis** - resulting in cortisol deficiency and increased ACTH
            - **Secondary minerocorticoid excess** - excessive ACTH stimulation despite blockade results in secondary hyperaldosteronism

      
      ![](img/moa_of_abiraterone_causing_secondary_minerocorticoid_excess.png)
    ...
    - **Androgen receptor blockers** - 2nd generation anti-androgen therapy:
        - <u>Selection</u>:
            - Apalutamide (TITAN trial)
            - Enzalutamide
