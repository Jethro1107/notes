---
id: 69ccea53-6171-4268-bb40-7ab3c7845f3b
title: Chest Pain
---
...
- **Etiology of chest pain** (ref [[Davidson Ch18 Cardiovascular Disease]]):
    - **Cardiac diseases:**
    ...
    - **Anxiety/ emotion**
- **Differentiating features in different types of chest pain** (ref [[Harrison Ch19 Chest Discomfort]]):
    ...
    - **Pleurisy** - sharp, well localised chest pain (often lateralised), exacerbated by deep breathing or coughing
    ...
    - **Tracheitis** - raw upper retrosternal pain exacerbated by the accompanying cough
...
- **Clinical approach to acute chest pain** (ref [[Harrison Ch19 Chest Discomfort]]):
...
- **Salient points of Hx:**
    - **HPI** - characteristic of chest pain to <u>differentiate between cardiac, and non-cardiac chest pains</u>: 
	    ...
	    ![](../img/ischaemic_chest_pain_based_of_balance_of_evidence.png)
        - <u>Site</u>:
            - **Cardiac chest pain** - central, retrosternal, and poorly localised/ diffuse
            - **Non-cardiac chest pain** - peripheral, and well localised
        - <u>Onset</u> - ischaemic chest pain takes time to develop to maximum intensity:
...
- **Subsequent evaluation** - based on clinical likelihood of CAD (see notes on Chronic Coronary Syndrome)
