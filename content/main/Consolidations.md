---
id: A6FD8F56-71FE-40C5-A778-FFE36F6F1433
roam_parent: 068e719c-234b-4c78-8d9e-6e153722ff71
...
- **Perilobular pattern:**
    - **Description** - similar concept to "septal thickening" but broader, referring to polygonal or irregular opacities with poorly defined margins surrounding the secondary pulmonary nodule:
        - Often in associations w/ consolidative changes or GGO
        - Reflects to a similar process as reversed halo sign, i.e. a response to an acute lung injury

    
    ![](../img/perilobular_opacities.png)
    - **DDx of perilobular pattern:**
        - Organizing pneumonia
        - CEP
        - COP secondary to myositis w/ anti-MDA5
        - COVID-19
