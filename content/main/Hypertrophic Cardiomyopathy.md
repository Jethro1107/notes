---
id: c948b9b3-4823-42ca-b915-7ba2b674163e
...
- **Definition and terminology:**
    - <u>Hypertrophic cardiomyopathy</u> (HCM) - defined as inappropriate and elaborate left ventricular hypertrophy and associated diastolic dysfunction that develops in the absence of 1) causative haemodynamic factors, or 2) systemic infiltrative or storage diseases
...
- **Pathophysiology of HCM:**
    ...
    - **Systolic anterior motion of the anterior mitral valve leavelet:**
        - <u>SAM of the anterior MV leavelet</u> - mitral valve pulled anteriorly due to high velocity of blood pumping out the LV (Venturi effect), manifesting as **mitral regurgitation**, and increased LA pressure
        - <u>Dynamic LVOT obstruction</u> - present in 30% at rest, and can be provoked by exercise in another 30%:
            - Pushing of anteriorly displaced and enlarged anterior mitral leaflet in contact w/ the hypertrophied ventricular septum
            - Often can be enhanced by bedside maneuvers that improve drag forces by reducing venous return (e.g. Valsalva maneuver or standing from a squatting position
- **Clinical features of HCM** - similar to those w/ AS but **clinical deterioration is slow**:
    ...
    - **Exertional dyspnoea** - SAM of anterior mitral valve leaflet results in acute MR, resulting in increased LA pressure, pulmonary congestion, and acute pulmonary oedema
    - **Exertional angina** - inability to increase cardiac output due to LVOT obstruction to meet increased myocardial demand results in myocardial ischaemia
    - **Arrhythmia** - may result in manifestation of acute decompensated heart failure, cardiogenic shock or **sudden cardiac death**
...
- **Signs:**
  ...
  ![](../img/clinical_features_of_hcm.png)
- **Ix:**
    - **12-lead ECG:**
...
- **Prognosis:**
    - <u>Mortality</u> - remains higher than in an age-matched population w/o HCM
    - <u>Risk of SCD</u> - baseline of \< 1% per year but dependent on presence of risk factors
    - <u>Disease progression</u> - 5% progress to overt systolic dysfunction (HFrEF) w/ or w/o dilated remodelling (i.e. “burned out” or end-stage HCM) a/w increased mortality as a result of HFrEF
    - <u>Poor-prognostic factors for sudden death from HCM</u>: 
    ![](../img/risk_factors_for_scd_in_hypertrophic_cardiomyopathy.png)
