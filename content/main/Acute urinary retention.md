---
id: e6505fa2-02b4-4527-b142-5703d2c571d7
title: Urinary Retention
---

# Urinary Retention

- **Urinary retention** - retention of urine within the urinary bladder causing <u>inability to voluntary pass urine</u>
    - Acute retention of urine (AUOR) - sudden onset and painful
    - Chronic retention of urine (CUOR) - gradual process and painless

## Acute urinary retention

- **Definition** - urological emergency characterised by the sudden inability to voluntarily pass urine
- **Epidemiology:**
...
- **Clinical features of AROU** - suspect AROU on anuria for few hours a/w suprapubic discomfort:
    - **Anuria for several hours**
    - **Lower abdominal pain/ suprapubic discomfort** - patient often severely distressed
    - +/- evident neurological cause
...
- **Etio-pathophysiology of AROU** - poorly understood, but likely caused by several contributary factors:
    - **Bladder outflow obstruction** - caused by obstruction of urinary flow distal to the bladder neck by static or dynamic factors:
        - <u>Prostate pathologies</u> - Benign prostatic hyperplasia (53% in M w/ AROU), Prostate cancer (rare)
...
- **Urethral catheterisation** - indicated in all patients except for certain selected patients:
    ...
    - <u>Reasons for inabilility to pass in Foley</u>:
        - Poor technique
        - Lack of anaesthesia
