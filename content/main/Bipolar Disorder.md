---
id: 0C7DDD0F-3FAD-46E9-90A8-D24BD3DF8DB3
...
- **Terminology and historical context** - bipolar disorder is the modern conceptualisation of what Kraepelin coined as "<u>manic-depressive insanity</u>" in his dichotomy of psychotic disorders:
    - The major differentiating feature regards the natural Hx of disease, where there is <u>little cognitive deficits</u> compared to schizophrenia (which he termed "dementia praecox")
    - Episodic mood is also the prominent feature in bipolar disorder, and delusions are typically secondary to the mood state 
    ![](../img/fluctuation_of_moods_in_mood_disorders.png)
    - Contents and durations of the psychotic symptoms is also a major differentiating features (see below)
...
![](../img/dsm-5_classification_of_mood_disorder_slides.png)
    ...
    ![](../img/epidemiology_of_bipolar_and_unipolar_disorders.png)
...
- **Clinical course and natural Hx of bipolar disorders** (ref [[Oxford Ch10 Bipolar Disorders]] and GC163 Lecture Notes)- epsiodic mood disturbances, where average length of manic episodes last ~ 6mo, usually w/ full clinical remission in between episodes:
    ...
    - <u>Subsequent episodes and risk of relapse</u>:
        ...
        - On avg 10 episodes of major mood disturbances over a 25y follow up (avg 4 episodes in first 10y)
        - 40% relapse within 2y despite Tx
        - \< 20% achieve 5y period of clinical stability w/ good social and occupational performance
        - Intervals beween episodes becomes progressively shorter (e.g. 1 episode per year \[cf rapid cyclers\]) w/ age and number episodes ("**kindling effect**")
    - <u>Remission</u>:
    ...
    - <u>Recovery from mood Sx</u> - as described most will eventually recover:
        - Manic episodes - manic episodes will resolve w/ or w/o Tx (median duraiton of 4-6 mo if untreated), although may have resulted in catastrophic consequences)
        - Depressive episodes - most eventually recover, but residual Sx is much more common
    - <u>Functional recovery</u> - lags behind that of recovery from mood Sx:
        - Especially w/ respect to occupational recovery
        - 30% show severe impairment in work role function between episodes (N.B. cognitive deficit in "neuroprogressive theory of bipolar disorder")
- **Poor prognostic factors predicting relapse:**
    - Previous relapse (most predictive)
    - Rapid cyclers (by definition requires frequent mood episodes)
...
- **Classification criteria:**
    - **Differences in classification criteria:**
	    ...
	    ![](../img/classification_of_bipolar_disorders_mania_hypomania.png)
    - **DSM-5 categorisation of bipolar disorders into bipolar I and bipolar II disorders** (ref [[DSM-5- Bipolar and Related Disorders]]) - intent is to correctly classify patients as having bipolar II disorders instead of recurrent major depressive disorders:
        - [[Bipolar I Disorder]] - bipolar disorder in which mania has occured at least one ocassion
        - [[Bipolar II Disorder]] - in which hypomani has occured, in the context of current major depressive episode (presence of manic episode precludes the diagnosis of bipolar II)
	    ![](../img/dsm_5_bipolar_1_diagnostic_criteria.png) 
	    ![](../img/dsm_5_bipolar_2_diagnostic_criteria.png)
- **Major DDx of mania** (ref [[Oxford Ch10 Bipolar Disorders]]):
    ...
    - **Drugs or medical conditions causing manic Sx:**
        - <u>Drugs</u> - illicit drugs (e.g. stimulants as above), steroids, L-dopa, antidepressants, ECT
        - <u>Medical conditions</u> - frontal lobe pathology, Hyperthyroidism, Cushing's syndrome
- **DDx of bipolar disorders** (ref [[DSM-5- Bipolar and Related Disorders]]):
...
- **Psychiatric comorbidity of bipolar disorder** ([[DSM-5- Bipolar and Related Disorders]]):
    - Anxiety disorder (75%)
    - ADHD, any disruptive, impulse-control or conduct disorder
    - Substance suse disorder (\> 50%)
- **Conception of staging of bipolar disorder** (Berk et al 2017) - worse prognosis w/ frequent relapse, a/w increased risk of future dementia
- **Etiology of bipolar disorders:**
    ...
    - **Environmental factors in bipolar disorders** - often <u>general risk factors</u> for most affective disorders or more general psychiatric illnesses: - <u>Childhood sexual abuse</u> - higher rates than healthy controls but similar or lower than other psychiatric illnesses; association drawn here as **childhood sexual abuse knwoown to link to development of psychosis** - <u>Life events</u> - generally known to precipitate episodes of both depression and mania in bipolar patients, and is generally more important in initial episodes, suggesting a possible "**kindling effect**"; possibly mediated through effects on circadian rhythms - <u>Social support</u> - **high levels of expressed emotion** (EE) a/w affective symptomatology and risk of relapse in bipolar disorders in a similar manner as schizophrenia
    - **Neurobiological approaches to etiology of bipolar disorders:**
...
- **Assessment of bipolar disorder:**
    - <u>Initial screening</u> - using screening instruments (see below)
    - <u>Clinical assessment</u> (Hx and P/E) - Hx often supplemented by an informant, confirm Dx, r/o other psychiatric or medical DDx, determine severity and risk assessment
- **Salient points of Hx** (ref Clinical Skills Session \[3/3/26\]):
    - <u>Sociodemographic features</u> - N.B. no sex preponderance, usu. age of onset in late adolescence to early twenties (consider organic causes or chronic bipolar if late presentation)
    - <u>HPI</u>:
        - Reason for consultation and pathway to care
        - Symptom clarification (current Sx, past Sx)
    - <u>Past psychiatric Hx</u> - prior counselling if present:
        - General courses of illness (number of episodes, worst episodes, hospitalisations, duration of hospitalisations, Tx received)
        - Inter-episodic remission status (full remission more likely bipolar comared from other psychotic disorders)
        - Past Hx of anti-depressant mania (if applicable)
    - <u>PMH and drug Hx</u>:
        - Drugs attributing to manic/ depressive Sx (L-dopa, steroids)
        - Drugs affecting choice of mood stabiliser and antipsychotics
        - Medical conditions mimicking depressive and manic episodes
        - Substance abuse
    - <u>FHx</u>:
        - Known psychiatric illness such as schizophrenia, bipolar or depression
        - Symptomatology in family members suggestive of a disorder despite not being linked to care
        - Suicide attempt in family
        - Characterise mental health literacy and family support
    - <u>Personal Hx</u>:
        - Childhood events
        - Education level (as baseline of cognitive function and modify presentation of mood Sx)
        - Employment record (premorbid functioning, any sudden giving up jobs)
        - Marital status
        - Foresnsics
    - <u>Personality</u> - clarifying pre-morbid personality as this alters interpretation of current Hx:
        - General mood (e.g. dysthymia)
        - How risk taking normally
        - Interpersonal Hx
    - <u>Risk assessment</u> - violence, impulsivity, self-harm
- **Assessment tools and instruments for bipolar disorders:**
    - <u>Screening instruments</u> - mood disorder questionaires, HCL-32
    - <u>Assessment of severity of manic episodes</u> - young manic rating scale (UMRS)
- **Severe manic episode** - manic episode where:
...
- **Mx:**
    ...
    - **Mx of acute mania** - CANMAT guideline:
        ...
        - **Approach:**
			- <u>Initial therapy</u> - montherapy on mood stabilisers/ atypical antipsychotics
...
- **Mx of acute mania:**
	- **Principles of Mx:**
		- _Goals of Mx_:
			- Reducing symptomatology -  including physical and mental overactivity, and features of psychosis
			- Protection of patient from overactivity - such as deteriorations of health from exhaustion, sleep deprivation, or poor fluid intake, and potentially halmful consequences of mania
		- _Approach to Mx_:
			- Pharmacological therapy - combination of antipsychotics +/- mood stabilisers or benzodiazepines to reduce overaactivity and improve sleep
			- Electroconvulsive therapy - usted in treatment-refractory cases where imposing physical deterioration
	- **Assessment:**
	...
	- **Efficacy and tolerability of agents used to treat acute mania** ([ciprianiComparativeEfficacyAcceptability2011](https://www.notion.so/jethros-working-notes/ciprianiComparativeEfficacyAcceptability2011-338b6ac73fa881c0a58cc45a5ba766bd?source=copy_link)):
		
		![[Pasted image 20260405122012.png]]
		
		![[Pasted image 20260405122025.png]]
	- **Pharmacological management** ([yathamCanadianNetworkMood2018](https://www.notion.so/jethros-working-notes/yathamCanadianNetworkMood2018-325b6ac73fa8815cbff2f7c2b75f35d4?source=copy_link)):
		
		![[Pasted image 20260404161218.png]]
		
		![[Pasted image 20260405114356.png]]
		...
		- _Monotherapy vs combination therapy decision making_ - listed separately as 1st-line Tx, decision for trial of combination therapy includes:
			- Speed of response (combination treatments tend to work faster)
			- Whether the patient had a previous history of partial response to monotherapy
			- Severity of mania
			- Tolerability concerns with combination therapy
			- Willingness of the patient to take combination therapy
		- _Subsequent steps in escalation of Tx_:
			- Step 3: alternative first-line agents (consider add on or switch therapy)
			- Step 4: second-line agents (considered as generally efficacious [Level 1 evidence], but limited by safety/ tolerability risks)
			- Step 5: thrid-line monotherapy or combination therapy
			
			![[Pasted image 20260405114915.png]]
	- **Assessment of treatment response** - evaluation of efficacy and tolerability at the end of week 1 and 2 and modify treatments accordingly:
	...
	- **Clinical features that help direct treatment choices:**
		- _Lithium indications_ - preferred for "classical manic episodes":
			- Prominent grandiosity
			- Elated mood in the absence of depressive symptoms
			- Mania-depression-euthymia course
			- Few prior episodes of illness
			- Family history of BD, especially with a family history of lithium response
		- _Valproate (Divalproex) indications_ - equally effective in those w/ classical and dysphoric mania, considered in:
			- Multiple prior episodes
			- Predominant irritable or dysphoric mood
			- Comorbid substance abuse
			- History of head trauma
		- _Carbamazepine indications_ - considered in:
			- History of head trauma
		...
		- _Combination therapy_ - first-line combination therapy w/ (lithium/ valproate), and an atypical antipsychotic dependent on:
			- Severity of manic episode
			- A response is needed faster as patient is judged at risk
			- Previous history of partial acute or prophylactic response to monotherapy
			- Manic patients w/ **mood-incongruent psychotic features** (e.g. non-grandiose delusions) and when **schizoaffective disorder** is a diagnostic consideration (no evidence, primarily based on clinical experience)
		- _Anxiety considerations_ - certain first- and second-line agents have specific **anxiolytic benefits**:
			- First-line agents - divalproex, quetiapine
			- Second-line agents - carbamazepine, olanzapine
		- _Psychotic features_ - generally mood-incongruent psychosis fare worse:
			- No evidence that any first-line monotherapy is superior for patients with psychotic features
			- No evidence that any particular first-line combination (eg, lithium or divalproex + atypical antipsychotic) is more effective than other first-line combinations
			- No evidence that any particular first-line combination (eg, lithium or divalproex + atypical antipsychotic) is more effective than other first-line combinations
		- _Rapid cycling_ - affects 33% of BD I:
			- Correction of contributory factors - hypothyroidism, antidepressant use, substance abuse
			- Combination of mood stabilizing drugs (e.g. lithium + divalproex) often required, although no evidence for triple therapy
	- **Assessment for symptoms of depressive disorder** - whether transient or sustained, suicidal risk is increased:
	...
	- **Typical antipsychotic drugs:**
		- _Selection_:
			- Haloperidol (Level 1 evidence but downgraded to second-line agent due to concerns w/ safety/tolerability risks)
			- Chlopromazine (Level 2 evidence, as third-line agent)
		- _Clinical efficacy_:
	...
	- **Atypical antipsychotic drugs** - now preferred over typical antipsychotics due to improved tolerability profile:
		- _Selection_ - the following SGAs are supported by RCTs (Cipriani et al 2011):
			...
			- Quetiapine
			- Respiradone
			- Olanzapine (Level 1 evidence but limited by safety and tolerability)
	...
	- **Electroconvulsive therapy in treatment of acute mania:**
		- _Clinical efficacy_ - only two prospective control trials but demonstrated superiority over conventional drug treatment:
			...
			- Possibly more effective in mixed affective states where depressive symptoms are prominent
		- _Duration_ - shorter durations in treatment of mania compared w/ treatment of depression
- **Mx of acute bipolar depression:**
	- **Principles of Mx:**
		- _Pharmacological therapy_ - clinical response to pharmacological therapy differs between manic states and depressive states:
			- Antipsychotics - only a selected number of SGAs are known to improve depressive symptomatology, where as FGAs are not useful in bipolar depression
			- Mood stabilisers - lamotrigine has the most evidence for improvement of symptomatology, where as evidence of lithium and valproate are more equivocal
		- _Psychotherapy_ - no evidence but can be tried in psychologically-minded patients
	...
	- **Lithium:**
		- _Role_ - limited in the treatment in bipolar depression, main role being the prevention of bipolar depression (however still a first-line agent for bipolar depression)
		- _Clinical efficacy_ - limited data:
			...
			![[Pasted image 20260406180948.png]]
	- **Atypical antipsychotics:**
...
- **Long term Mx of bipolar disorder:**
	- **Principles of Mx:**
	- **Lithium:**
