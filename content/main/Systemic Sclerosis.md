---
id: 5f7196bc-f33c-4973-b43d-7f6241cf9be8
...
## Investigations and Diagnostic Evaluation of Systemic Sclerosis

- **Concept of very early diagnosis of systemic sclerosis** (VEDOSS) - considering diagnosis <u>prior to first cutaneous manifestations</u>:
    - <u>Leroy and Medsger Criteria</u> (2001) - presence of the following features defines an "early SSc" in the absence of cutaneous manifestations that predicts progression to definite SSc (65.9% in 5y):
        - 1\. Raynaud phenomenon
        - 2\. Systemic sclerosis-specific autoantibodies
        - 3\. Scleroderma-type changes on nailfold capiloroscopy

    
    ![](../img/leroy_and_medgar_vedoss.png)
    - <u>Very early diagnosis of systemic sclerosis</u> (VEDOSS) - diagnosis of this clinical entity requires 1) Raynaud phneomenon, 2) Puffy fingers, 3) Scleroderma-type changes on nailfold capiloroscopy, and 4) Systemic sclerosis-specific autoantibodies
- **Classification criteria for diagnosis of systemic sclerosis:** 
![](../img/2013_acr_eular_classification_criteria_of_ssc.png)
- **Ix and diagnostic evaluation** - a clinical diagnosis:
    - Inflammatory markers:
        - ESR - typically raised
        - CRP - typically normal unless extensive organ involvement or co-existing infections
    - LFT - reversed A/G ratio
    - Autoimmune screen:
        - ANA - 70% +ve
        - Topoisomerase 1 Ab - 30% +ve in DCSS
        - Anti-centromere Ab - 60% +ve in LCSS
- **Approach to initial evaluation and Dx** - clinical, laboratory, and radiological evaluation aimed at 1) diagnosis, 2) phenotyping, and 3) screening for organ involvement:
    - <u>Diagnosis</u> - primarily based on clinical and serological profile
    - <u>Phenotyping</u> - based on the specific autoAb and biomarkers; and consider broading immunological assessment if overlap syndrome is suspected
    - <u>Screening for organ development</u> - screening Ix for cardiac, pulmonary, and renal involvement of SSc (see details below)
- **AutoAb:**
    - **ANA** - +ve in ~95% patients w/ SSc
    - **SSc-specific autoAb and their clinical correlates** - presence of autoAb predicts organ involvement and severity of disease: 
    ![](../img/autoab_and_clinical_associates_ssc.png)
        - <u>ANA-Positive/Specific-Negative phenotype</u> - subgroup of patients exhibit +ve ANA but -ve for all known SSc autoantibodies is clinically distinct and **high risk**
- **Biomarkers** - several are routinely employed in practice to determine prognosis:
    - <u>ESR</u> - non-specifically elevated
    - <u>CRP</u> - not typically raised unless extensive organ involvement; defines a subset of patients at increased risk of progressive pulmonary fibrosis, pulmonary HTN, and mortality
    - <u>IL-6</u> - not typically performed in prcatice as CRP elevation is mediated by IL-6; raised IL-6 levels correlates to poorer disease in SSc-ILD
- **Screening for organ involvement** - dynamic, adjusted based on disease duration, and Ab profile:
    - 
...
- **Mx of Raynaud's syndrome** - keep warm with heated mittens; CCBs, PDE5 inhibitors
- **Mx of GERD-like manifestations** - PPI and anti-reflux agents
- **Mx of HTN** - aggressive Tx with ACEi even in renal impairment
- **Mx of Joint involvement** - NSAID or other analgesics
- \*Mx of **Pulmonary HTN** - bosentan
