---
id: 0d1fa842-22d7-4bd7-97c7-a60972a4eb4e
title: 2025-07-18
---

# Seizures and Epilepsy in Adults - Literature Search on UpToDate <span class="tag" tag-name="Reference"><span class="smallcaps">Reference</span></span>

- **References:**
    - [ILAE classification of seizures and epilepsy](https://www.uptodate.com.eproxy.lib.hku.hk/contents/ilae-classification-of-seizures-and-epilepsy?search=seizures&source=search_result&selectedTitle=5~150&usage_type=default&display_rank=5)
    - [Evaluation and management of the first seizure in adult](https://www.uptodate.com.eproxy.lib.hku.hk/contents/evaluation-and-management-of-the-first-seizure-in-adults?search=seizures&topicRef=14094&source=see_link)
- **Definitions:**
    - <u>Epilepsy</u> - heterogenous disorder of the brain characterised by an enduing predisposition to epileptic seizures, with many possible seizure types and syndromes, diverse etiology, and variable prognosis
- **International league against epilepsy (ILAE) framework** - guides diagnosis at 3 levels based on details of Hx and availability of testing:
  ...
  ![](../img/ilae_framework_and_levels_of_diagnosis.png)
- **Level 1 Dx** - seizure type: 
![](../img/ilae_classification_of_seizure_types.png)
    - **Classification by nature of onset:**
        - <u>Generalised onset seizure</u> - further broken down into motor and nonmotor seizures
        - <u>Focal onset seizure</u> - further subdivided based on level of wareness, nature of manifestation, and elemental features
    ...
    - **Classification of generalised onset seizures:**
        - <u>Generalised motor seizures</u> - divided based on the nature
        - <u>Generalised non-motor seizures</u> (absence seizures) - classified into typical, atypical, myoclonic, and eylid myoclonia
    - **Classification of focal onset seizure:**
        - <u>Classification based on level of awareness</u>:
            - Aware
            - Impaired awareness
            - Unknown awareness
        - <u>Classification based on initial manifestation</u>:
            - **Motor** - automatisms, atonic, clonic, epileptic spasms, hyperkinetic, myoclonic, tonic
            - **Non-motor onset** - autonomic, behavior arrest, cognitive, emotional, sensory (w/ added descriptors)

      
      ![](../img/added_descriptors_for_focal_seizures.png)
        - <u>Added descriptors</u>:
            - Focal to bilateral tonic-clonic - describes spreading of epileptic activity to contralateral hemisphere resulting in progression into tonic-clonic seizures
- **Level 2 Dx** - epilepsy type based on seizure types (a clinical and EEG Dx):
    - **General epilepsy** - originating or engaging bilateral distributed networks, affecting both hemispheres, but are often asymmetric and may not involve the entire cortex:
        - <u>Pathophysiology</u> - originate at some point within or rapidly engaging bilaterally distributed networks, which can be both cortical or subcortical
        - <u>EEG</u> - **generalised** spike-wave or generalised paroxysmal fast activity
    - **Focal epilepsy** - originating from networks limited to one hemisphere inferred clinically or from EEG:
        - <u>Pathophysiology</u> - limited network isolated to a single hemisphere responsible for seizures
        - <u>EEG</u> - focal discharges at normal state, but may show multifocal discharges on interictal EEG
    - **Generalized and focal epilepsy** - for epilepsies that have both generalised-onset and focal-onset seizures:
        - <u>Pathophysiology</u> - usually indicates several epilepsy syndromes a/w developmental and epileptic encephalopathies that occur early in childhood
        - <u>EEG</u> - may be generalised, focal/multifocal
    - **Unknown if generalised or focal epilepsy** - e.g. epileptic spasms appearing generalised by arising from focal lesion (disconcordant EEG and clinical findings or unvailable EEG and neuroimaging findings)
- **Level 3 Dx** - epilepsy syndrome:
    - Distinctive, recognisable seizure disorders by compatible clinical features, S/S, and known etiology (e.g. genetic)

  
  ![](../img/epilepsy_syndrome_by_age_of_onset.png)
...
## Evaluation and management of the first seiure in adults
...
- **Mx:**
    ...
    - **Initiation of anti-seizure medications:**
        ...
        ![](../img/mx_of_first_provoked_seizures.png)
      ...
      ![](../img/mx_of_unprovoked_seizures.png)
