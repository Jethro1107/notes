---
id: 61af9e0f-d8c1-4acc-af41-09a2744a8423
title: 2025-03-23
---

# Hepatocellular Carcinoma - Literature Search on UpToDate

- **Definition** - most common primary liver malignancy that usually develops in the setting of cirrhosis

## Clinical features and diagnosis of hepatocellular carcinoma

- **Principles of clinical presentation** - multifactorial causing a spectrum of clinical presentation of HCC depending on prior documentation of chronic liver disease:
    - <u>Asymptomatic</u> - especially among those who have been undergoing regular surveillance (AFP, TAUS) for HCC (e.g. chronic HBV carriers, cirrhosis)
    - <u>Presentation as liver decompensation in cirrhotic patients</u> - subsequently worked up in a previously asymptomatic Child's A cirrhois which suddenly presents with decompensated liver failure (e.g. variceal bleeding, malignant ascites)
- **Clinical features** - spectrum of clinical presentation for patients with HCC, can be asymptomatic, especially among those who have been undergoing regular surveillance:
    ...
    - **Effects of local tumour** - quite asymptomatic:
        ...
        - <u>Palpable mass</u> - in the upper abdomen, RUQ mass if right lobe, epigastric mass if left lobe
    ...
    - **Presentation as liver decompensation in known cirrhosis** - increased severity of pHTN due to portal-venous extension of HCC:
        - <u>Variceal bleeding</u>
        - <u>Worsening ascites</u>
    - **Presentation as complications of HCC:**
        - <u>Ruptured HCC causing intraperitoneal bleeding</u> - sudden onset of 1) severe abdominal pain, abdominal distension, and shock +/- anaemia
...
- **Clinical approach to suspected HCC** - initial Ix dependent on patient's risk for HCC:
    - **High risk of HCC** (HBV carriers, documented cirrhosis) - routine **surveillance Ix** for early detection of HCC, with <u>diagnostic evaluation when indicated</u>:
        ...
        ![](~/Documents/notes/img/surveillance_TAUS_in_high_risk_HCC_algorithm.png)
...
## Post-diagnostic evaluation of HCC - Staging and prognostic factors
...
- **Staging and prognostic scoring system** - none of which is universiably adpoted (BCLC and HKLC are widely adopted):
    - **Commonly applied staging and prognostic scoring system:**
        ...
        - Hong Kong Liver Cancer (HKLC) system - newly adopted with resemblance to BCLC, but better stratification for intermediate/ advanced stages allowing more aggressive Tx
    ...
    ![](~/Documents/notes/img/TNM_staging_HCC.png)
    ...
    ![](~/Documents/notes/img/okuda_system_HCC.png)
    ...
    ![](~/Documents/notes/img/CLIP_score_HCC.png)
    - **Barcelona Clinic Liver Cancer (BCLC) System** - prognostication system and treatment algorithm based on 1) <u>Extent of primary lesion</u> (size and number), 2) <u>performance status</u> (ECOG performance status), 3) <u>liver function</u> (Child-Pugh Score), 4) <u>vascular invasion</u>, 5) <u>extrahepatic spread</u> (N/M stage): 
    ![](~/Documents/notes/img/BCLC_HCC.png)
        - <u>Stratification</u>:
        ...
        - <u>Indications on Mx</u>:
            - **Stage 0-A disease** - liver resection indicated
            - **Stage B-C disease** - candidates for LT, chemoembolisation, palliative systemic therapy
            - **Stage D disease** - supportive care as prognosis extremely poor
        - <u>Strengths</u>:
            - Outperforms TCM staging in patients undergoing surgical therapy
        - <u>Limitations</u>:
            - Stage B disease show that resection for BCLC stage B disease impact outcomes and thus has limited utility in patients considering surgical Mx
    ...
    ![](~/Documents/notes/img/HKLC_HCC.png)
        - **Tumour status:**
    ...
    ![](~/Documents/notes/img/ecog_performance_status.png)
...
- **Principles of Mx** - stage-dependent:
    - **Potentially resectable disease** - verly early or early disease with demonstrable resectability and functional liver remnant
...
- **Hepatic resection** - Tx of curative intent in selected patients:
    ...
    - **Pre-operative assessment of resectability:**
        ...
        - **Assessment of tumour extent** - based on findings on triphasic CT A+P or MRI:
            ...
            ![](~/Documents/notes/img/hcc_survival_with_no_vascular_invasion_irrespective_of_size.png)
