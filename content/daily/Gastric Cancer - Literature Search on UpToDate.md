---
id: e27b0e2b-9cd9-4c00-88bc-1123a73d9fd2
title: 2025-03-25
---

# Gastric Cancer - Literature Search on UpToDate
...
![](~/Documents/notes/img/TNM_gastric_cancer.png)
    ...
    - **N staging** - regional LN differ for tumors involving different parts of the stomach
      ...
      ![](~/Documents/notes/img/regional_LN_gastric_cancer.png)
    ...
    ![](~/Documents/notes/img/TNM_prognostic_gastric_cancer.png)
...
- **Staging Ix:**
    - <u>CT T+A+P</u> - indicated for all patients with gastric cancer for M staging
...
- **Surgical Tx:**
    - **Radical resection of gastric cancer** - complete surgical removal of the tumour w/ adequate margins and adjacent LN (R0 resection):
      ...
      ![](~/Documents/notes/img/partial_gastrectomy_and_reconstruction.png)
...
# Esophageal cancer - Literature Search on UpToDate : <span class="tag" tag-name="Surgery"><span class="smallcaps">Surgery</span></span> <span class="tag" tag-name="Reference"><span class="smallcaps">Reference</span></span>
...
- **Clinical presentation of esophageal cancer:**
    ...
    - **Complications of local invasion:**
        ...
        - <u>Intractable cough and recurrent pneumonia</u> - due to tracheobronchial fistulas, a late complication
- **Dx** - histological examination necessary:
    - **Upper endoscopy and biopsy** - necessary for diagnosis of CA esophagus:
        - <u>Endoscopic findings</u> - superficial plaques, nodules, strictures, or ulcerated masses
- **Staging System** - 8th edition TNM staging: ![](~/Documents/notes/img/TNM_staging_esophageal_cancer.png) 
![](~/Documents/notes/img/TNM_prognostication_esophageal_cancer.png)
    - Prognostic grouping is dependent on location and histology
- **Principles of staging evaluation:**
    - Detection of distant metastasis - Contrast CT T+A+P, 18-FDG-PET/CT, EUS (for liver metastasis and ascites) +/- diagnostic laparotomy
    - Evaluation of loco-regional disease - EUS +/- bronchoscopy for disease at or above carina
- **Staging Ix:**
    - <u>Endoscopic ultrasound</u> - for locoregional staging of invasive esophageal cancer (T & N staging) +/- intra-abdominal metastasis and malignant ascites
    - <u>Bronchoscopy</u> - to r/o airway invasion for potentially resectable thoracic esophageal cancer
    - \_
