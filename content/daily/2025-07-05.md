---
id: 19897802-7e7a-46db-b6da-963f7eda1578
title: 2025-07-05
---

# GC224 Hypertension and Pregnancy <span class="tag" tag-name="Lecture"><span class="smallcaps">Lecture</span></span>

## Hypertension in Pregnancy, Gestational Hyertension, Pre-eclampsia and Eclampsia
...
- **Classification of hypertension in pregnancy** - based on baseline BP (\< 20 weeks) and after BP:
...
- **Mx:**
    ...
    - **Mx of chronic HTN or mild non-proteinuric gestational HTN** - keep in mind BP falls slightly in second trimester:
        ...
        ![](~/Documents/notes/img/principles_of_mx_of_pet.png)
            - **BP lowering in severe eclampsia** - IV antihypertensives:
...
- **Mx of pre-eclampsia, eclampsia, gestational HTN** (read up):
    - Mild:
        - HTN - BP control
        - Fluid balance
        - Prevention of eclampsia - magnesium sulphate
        - Screening and Mx of associated complications (see slides) - CBC, LRFT, fetal USG, CTG
    - Severe - require delivery to avoid maternal and perinatal death
