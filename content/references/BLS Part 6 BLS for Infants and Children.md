---
id: 713d7530-9656-455c-93d6-89e835067e7e
title: BLS Part 6 BLS for Infants and Children
---

# Part 6: BLS for Infants and Children

- **Paediatric BLS algorithm** - Single rescuer: 
![](img/single_paediatric_bls_algorithm.png)
- **Paediatric BLS algorithm** - 2 or more rescuers: 
![](img/multiple_paediatric_bls_algorithm.png)
- **Description of paediatric BLS alogorithm:**
    ...
    - **Step 3** - assess pulse and breathing simutaneously (\< 10s):
        - **Assessing breathing and pulse:**
            - <u>Pulse</u> - check carotid pulse, brachial pulse, or femoral pulse
        ...
        - **Escalation of BLS algorithm:**
            ...
            - <u>Abnormal breathing but pulse present</u> - rescue breaths (every 2-3s) while assessing pulse (start CPR if \< 60bpm)
            - <u>No breathing and pulse</u> - start CPR and early defibrillation (initiate emergency response if witness collapse)
    - **Step 4** - initiate high-quality CPR:
        - **Chest compressions:**
            - <u>Position</u> - faceup on firm, flat surface, rescuer at victims side
            - <u>Compression-to-ventilation ratio</u> - 30:2 if single rescuer, 15:2 if 2 rescuers
            - <u>Compression rate</u> - 100-120 bpm
            - <u>Compression depth</u> - 1/3 of AP diameter of chest (4cm in infants, 5cm in child)
            ...
            - <u>Technique</u>:
                - One hand technique for child 
                ![](img/two_finger_compression_infant.png)
                - 2 finger or 2 thumb encircling hand technique (preferred) for infant 
                ![](img/encircling_hand_technique.png)
        - **Breaths:**
    ...
    - **Step 5** - AED to check rhythm to see if rhythm shockable (check every 2m), note that adult pads or adult shock doses is better than no defibrillation
