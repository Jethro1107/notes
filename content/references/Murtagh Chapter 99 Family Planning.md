...
- **Domains of a family planning consultation** - it often begins w/ the presentation of a young woman for contraceptive advice:
	- Addressing health concerns
	- Health promotion
	- Menses regulation
	- Discussions regarding health-related aspects of sexual activity
	- Planned parenthood
...
- **Important considerations for a family planning consultation:**
	- Initial visit is critical and an excellent opportunity to develop good rapport to ensure patient comes back for advice regarding family planning
	- Confidentiality of patients,  especially for teenagers, keeping in mind of Gillick test of competency
	- Figures and aids recommended for education to enhance therapeutic relationship and facilitate compliance
## Fertility Control

- **Factors influencing choice of contraception:**
	- Individual needs and personal preference
	- Effectiveness
	- Safety and incidence of S/E
	- Availability
- **Most commonly used contraception in order of preference in the Western World:**
	- Male condom
	- Combined oral contraceptive (COC) pills
	- Intra-uterine device (IUD)
	- Female sterilisation
	- Withdrawal
- **Long-acting reversible contraception** (LARC) - non-permanent contraception administered less frequently than once a month, and are most effective reversible contraceptives (failure rates of typical use same as for perfect use):
	- Implants
	- IUDs
	- Injectables 
	![[Pasted image 20260513210024.png]]
- **Contraceptive failure** - 50% of pregnancies are unintended in the US and occur because:
	- Non-use of contraception
	- Failure of a specific contraceptive method
	- Discontinuation of contraceptive or barrier methods
- **Dual protection:**
	- Use of condoms in addition to an effective form of contraception
	- Offers both STI (only offered by condoms) and pregnancy prevention
- **Effeciveness of various contraceptive methods:**
	![[Pasted image 20260513210658.png]]

## Safe Prescribing

- Most women of reproductive age can safely use all contraceptive methods, but there are some conditions, risk factors, and concurrent medications that make a particular method unsuitable
- **Medical Elligibility Criteria tables for contraceptive use** (MEC) - an internationally recognised system to guide clinicians in the safe provision of contraceptive methods, classifying conditions affecting eligibility under 4 categories:
	- _MEC 1_ - no restrictions
	- _MEC 2_ - the benefits generally outweigh the risks
	- _MEC 3_ - the risks generally outweigh the the benefits
	- _MEC 4_ - absolute contraindications
...
- **Definition** - highly effective LARCs involving inserting an inert material to which may be added a bioactive substance such as copper (Multiload Cu375) or progestogen (Mirena)
- **MOA of IUDs:**
	- Inhibition of sperm migration
	- Prevention of ovum transport and implantation
	- Suppression of endometrial thickening and cervical mucus thickening +/- prevention of ovulation (Mirena)
- **Efficacy:**
	- _Cupper IUDs_ - 99.4% perfect use; 99.2% typical use
	- _Merina_ - 99.8% perfect and typical use
- **S/E and Cx of IUDs:**
	- **Changes in menstrual bleeding patterns and pain:**
		- _Coper IUD_ - result in HMB and dysmenorrhoea, sually more common in first 3-6 mo but decreases w/ time
		- _Merina_ - results in decrease in blood lost, many become amenorrhoeic w/ time
	- **Pregnancy-related S/E:**
		- _Miscarriage and intra-uterine sepsis_ - increased risk of spontaneous abortion and intra-uterine sepsis in the second trimester if pregnancy occurs (early removal of IUD essential)
		- _Ectopic pregnancy_ - incidence of ectopic pregnancy greater in those w/ IUD use, as IUDs prevent intra-uterine rather than tubal pregnancy (absolute risk lower than those w/o contraceptions)
	- **Pelvic inflammatory disease:**
		- Slight increase risk in first 20d post-insertion
		- Subsequent risk of PID reverts to baseline and is related to risk of STIs
	- **Extrusion, translocation, and perforation of the uterus** - FU within 3-6 weeks to exclude such complications by pelvic USG, or KUB:
		- _Extrusion_ - occurs in about 5% w/ the highest risk within the first year
		- _Translocation_ - migration outside the uterus into pelvic/ abdominal cavity w/ or w/o perforation of the uterine wall
		- _Perforation of uterus_ - occurs in 2.3/1000 insertions, increased risk w/ breastfeeding, 6mo post-partum, and previous caesarean section
