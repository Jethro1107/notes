---
id: b617724a-70d7-436e-bf83-3a4adf1bf69f
title: Harrison Ch304 Interstitial Lung Disease
---

# Ch304 Interstitial Lung Disease
...
- **Rationale for timely Dx of ILDs** - even when patient is asymptomatic:
    - Associated w/ high rates of morbidity and mortality
...
- **Salient points of Hx:**
    ...
    - **PMH**:
        - <u>Connective tissue disease</u> - note that ILD may be the initial presentation of CTD:
            ...
            - Screen for Sx commonly ssociated w/ STD (Raynaud's phenomenon, skin thickening, arthritis, myositis)
...
- **P/E:**
    ...
    - **Signs of advanced disease:**
        - <u>Digital clubbing</u> - usually only in advanced IPF, but not in all forms of ILD
...
- **Ix:**
    - **Laboratory Ix:**
        - **Baseline bloods** - CBC, LRFT, inflammatory markers
        - **Autoimmune markers** - ANA, Anti-centromere, Anti-Sc70, Anti-RNA, RF, Anti-CCP
...
- **Mx:**
    - **Principles of Mx:**
        ...
        - <u>Historical immunosuppressive therapy</u> - no benefits to lung pathology, associated w/ increased morbidity and mortality
...
- **Prognosis** - poor (50% 3-5y survival)

### Nonspecific Interstitial Pneumonia

- **Definition** - a distinct clinical entity, although idiopathic, defined by characteristic clinical, radiological, and histopathological features which are often polar opposite to findings of UIP
- **Epidemiology:**
    - <u>Prevalence</u> - not well established
    - <u>Demographic</u> - usually non-smoking women in 5th decade (often w/ ?ANA seropositivity):
        - Age - 5th decade of life
        - Sex - female preponderance
        - Exposure - NS
- **Difference between idiopathic NSIP and NSIP:**
    - <u>Idiopathic NSIP</u> - a disease entity characterised by radiological and histopathological findings of NSIP, w/ no features suggesting an alternative diagnosis
    - <u>NSIP</u> - a **radiographical and histopathological pattern**, may be idiopathic, but also observed commonly in CTD-associated ILD, less frequently w/ familial interstitial pneumonia, drug toxicity and infection
- **Clinical manifestation** - typical manifestation of chronic ILD (dry cough and progressive exertional dyspnoea)
- **HRCT findings in idiopathic NSIP** - NSIP pattern:
    - <u>Characteristic NSIP pattern</u>:
        - Symmetrical and subpleural involvement w/ groud glass poacities (GGO) and reticular opacities
        - Volume loss and tractional bronchiectasis in lower zones can be found
        - Subpleural sparing, peribronchiolar thickening and honeycombing is rare
- **Histopathology in idopathic NSIP** - varying amounts of interstitial inflammation and fibrosis w/ <u>uniform pattern</u>:
    - Active inflammation characterised by cellular infiltrates (predominant cellular pattern potentially more likely to resolve w/ medical infiltrates)
    - Fibrosis and subpleural reticulation is common, while honeycombing and fibroblast foci is rare
- **Mx:**
    - **Principles of Mx:**
        - <u>Non-pharmacological therapy</u> - pulmonary rehabilitation, O2 therapy, lung transplantation w/ progressive disease
        - <u>Pharmacological therapy</u> - oral steroids (prednisone), cytotoxic agents (MMF, AZA, CTX), biologics (rituximab, tocilizumab)
- **Prognosis** - relatively good prognosis (80% 5y survival):
    - Better prognosis in those w/ predominent cellular NSIP pattern
    - Worse prognosis in those w/ fibrosing NSIP pattern

### Smoking-related ILD

- **Definition and terminology** - various ILDs where smoking is thought to be a result of active or prior tobacco smoke exposure:
    - **Disease entities subclassified into IIPs:**
        - <u>Respiratory bronchiolitis with interstitial lung disease</u> (RB-ILD)
        - <u>Desquamative interstitial pneumonia</u> (DIP)
    - **Disease entities not under IIPs:**
        - <u>Pulmonary Langerhan's cell histocytosis</u> (PLCH)
- **Epidemiology** - felt to account for \< 10% of IIPs
- **HRCT findings in smoking-related ILDs:**
    - <u>Characteristic findings in RB-ILD</u>:
        - Central and peripheral bronchial wall thickening
        - Centrilobular nodules
        - Ground glass opacities
        - Septal lines and reticular pattern not uncommon
    - <u>Characteristic findings in DIP</u> - usually diffuse (ocassionally patchy) bilateral symmetrical GGOs more predominant
- **Histopathology of smoking-related ILDs:**
    - Chronic inflammation of respiratory bronchiolar walls, w/ pigmented macrophage infiltrates, and both bronchiolar and peribronchiolar fibrosis resulting in architectural distortion
    - Changes are patchy in RB-ILDs, but more diffuse in DIPs
- **Mx:**
    - **Principles of Mx:**
        - <u>Smoking cessation</u> - counselled to discontinue smoking or enroll in formal smoking cessation programe
        - <u>Pharmacological therapy</u> - immunosuppressives, cytotixcs, and ocassional use of bronchodilators w/ no strong evidence

### Cryptogenic Organizing Pneumonia

- **Definition** - subacute flu-like illness of unknown cause with migratory lesions, often mistakened as pneumonia
- **Etiology of COP:**
    - Idiopathic
    - Secondary to CTD (esp. polymyositis and dermatomyositis)
    - Medications
    - Underlying malignancy (may be related to immune-mediated myositis)
- **HRCT findings in COP** - patchy, and ocassionally migratory lesions:
    - Subpleural opacities associated w/ GGOs
    - Peribronchiolar or perilobar involvement also present
    - Reversed halo sign (rim of subpleural sparing)
- **Histopathology of COP:**
    - Patchy regions of organiszing pneumonia evident by granulation tissues
    - Often in with surrounding inflammation that may affect alveolar wall
- **Mx** - corticosteroids (may be required up to 6 mo as relapse rate high)
...
## ILD Assoicated with Connective Tissue Disease

### Systemic Sclerosis-Associated ILD

### Rheumatoid Arthritis-Associated ILD

### Dermatomyositis/ Polymyositis-associated ILD
