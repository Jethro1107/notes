---
id: 7DA73886-E977-4D3B-A544-730779A09340
title: Harrison Ch290 Deep-Venous Thrombosis and Pulmonary Thromboembolism
---

# Ch290 Deep-Venous Thrombosis and Pulmonary Thromboembolism

- **Overview:**
    - <u>Venous thromboembolism</u> (VTE) - encompasses both deep-venous thrombosis (DVT) and pulmonary embolism (PE)
    - <u>Burden</u> - causes of cardiovascular death, chronic disability, and emotional distress
    - <u>Increasing proportion of hospitalisations related to PE</u> - hospitalisations in the US for AMI, ADHF, stroke have steadily decreased, while tha for PE is increasing
...
- **Epidemiology:**
    - **Demographic:**
        ...
        ![](../img/30_day_mortality_of_pe_stratified_by_ses.png)
    - **Burden:**
...
- **Inflammation** - center-stage as a <u>trigger for acute DVT and PE</u> (?endothelial injury), where inflammation-related risk factors and medical illnesses are now linked as precipitants of PE: 
![](../img/inflammation_triggers_of_pulmonary_embolism.png)
...
- **Interaction between venous thromboembolism** (red clot) **and arterial thrombosis** (white clot): 
![](../img/broad_interactions_between_venous_thrombosis_and_atherothrombosis.png)
- **Virchow's triad:**
    - Abnormal blood flow
    - Stasis
    - Endothelial injury
...
- **Effects on lung physiology** - gas exchange abnormalities include 1) arterial hypoxaemia, and 2) increased A-A O2 tension gradient, reflecting inefficiency of O2 transfer (due to dead space ventilation):
    ...
    - <u>Impaired gas exchange</u> - due to:
        - Anatomical dead space from vascular obstruction
...
![](../img/pathophysiology_of_pe_harrisons.png)
...
## Classification of Pulmonary Embolism and Deep-Vein Thrombosis
...
- **Classification of DVTs:**

## Diagnosis

- **Clinical features of PE** - S/S is non-specific:
    - **Shortness of breath** - usually acute <u>unexplained SOB at rest</u> (ocassionally on exertion):
    ...
    - **Pleuritic chest pains** - <u>pleurisy</u> as a result of pulmonary infarction:
...
- **Clinical evaluation** - known as "the great masquerader" as S/S are often non-specific and risk factors are not always evident ("unprovoked PE"):
    ...
    ![](../img/harrisons_modified_wells_score_for_dvt_and_pe.png)
    - <u>Integrated diagnostic approach of DVT and PE</u>: 
    ![](../img/integrated_diagnostic_approach_to_dvt_and_pe.png)
...
- **ECG** - usually shows sinus tachycardia:
  ...
  ![](../img/s1q3t3_and_rv_strain_due_to_pe.png)
...
![](../img/risk_stratification_of_pulmonary_embolism.png)
...
- **Further risk stratification of PE for home Tx:**
    ...
    ![](../img/aujesky_2011_outpatient_care_for_low_risk_pe.png)
...
- **Approaches to initial and primary Mx of PE** - 3 major strategies:
  ...
  ![](../img/initial_anticoagulation_dosing_for_vte.png)
- **Duration of anticoagulation** - moving away from dichotomy of provoked and unprovoked events as they appear to have similar rates; rather determine whether risk-factors are still persistent and risk of recurrences:
    ...
    - <u>Reassessment and determine enduring risk factors and risk of recurrence</u> - consider secondary risk prevention if intermediate risk or higher: ![](../img/risk_of_recurrence_for_vte_after_discontinuing_anticoagulation.png) 
    ![](../img/indication_for_indefinite_anticoagulation_for_secondary_prevention.png)
