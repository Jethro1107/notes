---
id: 56ECA4D9-DDED-4E0C-AF4A-6D343A34F125
title: Oxford Ch20 The Misuse of Alcohol and Drugs
---

# Ch20 The Misuse of Alcohol and Drugs
...
- **Classes of substances in substance use disorder:** 
...
- **Moral model of alcohol drinking:**
    - If people drink too much, they do so of their own will, but if their drinking causes harm to them or their famil, their actions are morally bad
    - The collorary of this attitude is that public drunkeness or criminal activity should be punished, and in fact is the legal practice in most countries
    - One may argue that this is harsh or unsympathetic, although a better argument against such legal practice is that <u>there is little practical justification for punishment</u>, since there is <u>little evidence</u> that it influences drinking behaviours
- **Medical model of alcohol drinking:**
    - A person who misuses alcohol is ill rather than wicked
    - Popularised by the book "The Disease Concept of Alcoholism" (by E. Morton Jellinek) that embodies 3 basic ideas, 1) Excessive drinking may lead to physical and mental disease of several kinds, 2) Excessive drinking progresses through well- defined stages, at one of which the person can no longer control their drinking, and 3) Some people have a specific vulnerability to alcohol misuse
    - This is more humane, and implies that instead of punishment, treatment should be offered
    - Major limitations of this idea includes that dependence is a physiological process that occurs in all, that alcohol limitation only applies to at risk individuals, and that excessive drinking, at least initially is not a product of personal choice
- **The best of both worlds:**
    - Moral model to excessive drinking deters people from being at risk of alcohol-related disorders
    - Medical model is to be applied to those who already present w/ alcohol-related disorders, and that treatment is more effective than punishment to stop harmful use
...
- **Alcohol withdrawal:**
    - Various symptomatology occuring when alcohol intake decreases or stops
    - 5% of dependent patients will experience severe withdrawal symptomatology including delirium tremens and GTCS
...
- **Alcohol withdrawal syndrome** - wtihdrawal symptoms vary across a spectrum of severity from mild anxiety and sleep disturbances to dilerium tremens and GTCS:
    ...
    - **Methods to stave off withdrawal symptoms:**
        ...
        - Use of rough cider, cheap strong beers often and regularly as to obtain the most units of alcohol for the cheapest cost
    - **Features of alcohol withdrawal** - are easily relieved by a drink, otherwise will last a few days:
        ...
        - <u>Misperceptions and hallucinations</u> - may occur as withdrawal progresses but are usually brief, where objects appear distorted in shape, or shadows appear to move, w/ distorted voices, shouting, snatches of music occur
    ...
    ![](../img/signs_and_symptoms_of_alcohol_withdrawal.png)
...
1.  Physical Damage
    ...
    - **Alcohol women's health, and pregnancy:**
      - Women progress more rapidly than men to problem drinking, and suffer the medical consequences of alcohol use after less exposure
      - Increased risk of breast cancer, amenorrhoea, and premature menopause
      - Alcohol intake during pregnancy a/w fetal abnormalities (2%), where fetal alcohol syndrome is most severe
    - **Mortality:**
...
2.  Psychological Damage
    ...
    - **Alcohol-related psychiatric disorders fall into four groups:**
      ...
      - Toxic and nutritional disorder
    ...
    - **Delirium tremens** - medical emergency a/w high mortality if poorly treated:
		...
		- **Clinical features of delirium tremens:**
			...
			- <u>Altered perceptual experiences</u> - with misinterpretation of sensory stimuli to brief visual hallucinations (e.g. grasp for imaginary objects, lilliputian hallucinosis)
...
### The Cause of Excessive Drinking and Alcohol Misuse
...
### Early Detection and Treatment of Alcohol Misuse
...
- **Total abstienence versus controlled drinking:**
    - Medical model of alcohol dependence proposes that the patient should become totally abstinent and remain so, as a single drink can result in relapse (AA has made this a tenet of their approach)
    - Counterview that controlled drinking presents as an alternative if dependence is caught early, and for those who are not dependent or physically dmaged
    - Generally those who have failed controlled drinking should aim for total abstinence
...
- **Data on drugs misuse and dependence:**
...
- **Types of opioids:**
	...
	- Heroin
	- Codeine
	- Synthetic analgesics (e.g. pethidine, methadone)
	- Other prescribed analgesics (tramadol, oxycodone, dihydrocodeine)
- **Pharmacological effects of opioids** - primarily through interaction w/ specific opioid receptors (morphine and heroin selective to μ-opioid receptor type):
	- _Analgesic effects_ - main medical use of opioids due to their powerful analgesic effects
	- _Effects on mood_ - produces a euphoriant effect (heroin has particularly powerful effects especially if taken intravenously)
	- _Effects on anxiety_ - produces an anxiolytic effect  
- **Epidemiology:**
	- _Prevalence_ - 12 mo prevalence in the UK around 0.3%, w/ rates of dependence around 0.1% (lifetime risk of opiate use ~ 2% in the UK)
	- _Demographic_ - higher rates would be expected in the homeless and in prisons
- **Use and misuse:**
	- Epidemiological data indicate that many people use heroin w/o becoming dependent on it
	- However, there is no doubt that repeated heroin use can lead to rapid development of marked physiological tolerance and dependence
	- Physiological tolerance is often accompanied by trial of other _routes of administration_:
		- Skin-popping - subcutaneous administration
		- Snorting - sniffing via intranasal route
		- Chasing the dragon - heated on a metal foil and inhaled
		- Injections - intravenous route (from perspective of harm reduction, methods that avoid IV route is preferred)
	- Loss of tolerance is rapid when the drug is stopped, such that it is extremely dangerous after a period of abstinence followed by re-instatement of the previous dose (fatal respiratory depression)
- **Clinical effects of opioids:**
	- **Physiological manifestations** - tolerance does not develop equally to all effects, where constipation often continues while other effects are diminished:
		- Analgesia
		- Constipation
		- Reduced appet
		- Respiratory depression
...
- **Anxiolytics and hypnotic drugs commonly misused** - clinical effects thought to result from ability to directly or indirectly facilitate brain GABA function:
    - Benzodiazepines (most common)
    - Barbituates (previously common but now uncommon because less commonly prescribed)
    - Gabapentin and pregabilin

1.  Benzodiazepines

    - **Overview:**
      - Used for symptomatic relief of very distressing anxiety symptoms, not intended for prolonged use
      - Prolonged use could lead to tolerance and dependence
    - **Epidemiology** - use is widespread (up to 10% using benzodiazepines in the West):
      - Most common prolonged users are older women
      - Use in younger patients a/w IV administration and polysubstance misuse
    - **Dependence on benzodiazepines** o from prolonged medical use usually initially for sleep or anxiety, but emerging "street drug" promoted for euphoriant and calming effects:
      - Lowering dose results in re-emergence of anxiety symptoms, which is often mistakened as a persistent anxiety disorder
      - Estimated that 33% of patients on BZD for \> 6 mo will become dependent
    - **Clinical features of benzodiazepine withdrawal:**
      - <u>Anxiety symptoms</u> - anxiety, irritability, sweating, tremor, sleep disturbances
      - <u>Altered pereception</u>:
    ...
    - **Mx:**
      - <u>Dose reduction</u>:
        - Gradual reduction of dose over 8 weeks (reduction by one-eighth every 2 weeks)
        - Consider switchiing to long-acting BZD (e.g. valium) as short-acting BZD are more prone to withdrawal symptoms
      - <u>Pyschotherapy</u> - cognitive behavioural therapy can improve cessation rates
      - <u>Patient education</u> - many patients have persistent withdrawal symptoms when completely tapered off, most subside within weeks but can persist (prolonged withdrawal syndrome)
    - **Prevention:**
      - Restriction of prescribing (do not initiate BZD for anxiety before exploring non-pharmacological alternatives)
      - Short-course at modest doses

2.  Gabapentin and Pregabalin

### Cannabis

- **Definition** - derived from the plant Cannabis sativa, consumed as dried vegetative parts in the form of marijuana or grass, or as the resin secreted by the flowering shoots of the female plant
- **Psychoactive componants of cannabis** - contains several pharmacologically active:
    - Tetrahydrocannabinol (THC) - effects mediated via activation of cannaboid receptors in the CNS
- **Epidemiology:**
    - Cannabis products are consumed in some parts of North Africa and Asia in a similar way to alcohol in Western society
    - Intermittent use of cannabis is common in North America and Europe common in young adults
    - Lifetime use of Cannabis in UK is 23%, w/ 7.5% surveyed reporting use in past year
- **Clinical effects of cannabis** - highly variable, and dependent on 1) dose, 2) person's mood, 3) person's expectation, and 4) social setting:
    - <u>Mood changes</u> - likely exaggerates the pre-existing mood, whether exhilaration or depression
    - <u>Perceptual experiences</u> - distortion of perception of time and space; increased enjoyment of aesthetic experiences
    - <u>Physiological effects</u>:
        - Reddening of the eyes
        - Dry mouth
        - Irritation of the respiratory tract w/ coughing
        - Tachycardia
- **Adverse effects:**
    - <u>Physical adverse effects</u> - generally no serious adverse effects in those use intermittently in small doses:
        - No +ve evidence in teratogenicity but yet to be proven to be safe in the initial 3 mo of pregnancy
        - Potentially carcinogenic if inhaled via the respiratory tract
    - <u>Psychological adverse effect</u>:
        - Anxiety
        - Mild paranoid ideations
        - Toxic confusional states and frank psychosis in clear sensorium
- **Cannabis and mental illness:**
    - Known to modify the course of schizophrenia where cannabis use a/w more +ve Sx, relapses and hospitalisations (SChoeler et al 2016)
    - Cannabis use also predisposes to new onset psychotic symptoms by two-folds, even after adjusting for confounders (Hall and Degenhardt 2011)
    - Association between cannabis and mood or anxiety disorders are less clear cut
- **Cannabis tolerance and dependence:**
    - Usually a/w prolonged use at high doses, but less evident for those who use small and intermittent doses
    - Lifetime risk of dependence for those exposed is only 9% (cf 15% for alcohol and 32% for nicotine)
- **Cannabis withdrawal** - non-specific Sx, but generally mild in nature:
    - Irritability
    - Nausea
    - Anorexia
    - Insomnia
